...
<html>
	...
	<body>
		<div id="mySidenav" class="sidenav">
          ...
          <?php echo anchor('index.php/form/logout', 'Sign Out'); ?>
			...
			<nav class="navbar navbar-toggleable-lg navbar-light" style="background-color:#4A235A" id="top">
				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
					...
					<ul class="ml-auto navbar-nav">
					   <li class="nav-item lead design">
							<?php $this->load->helper('url'); echo anchor('form', 'Sign Out', array('class' => 'nav-link', 'id' => 'nav-link-color')); ?>
						</li>
					</ul>
                ...
                <div class="modal-dialog">
                    <div class="modal-content bg-success">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel" style="color:white"> <?php echo $msg; ?> </h4>
